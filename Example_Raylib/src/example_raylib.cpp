    ...
    int main()
    {
        ...
        // Pack 1
        {
            rm::rLdr::PackBuffer pack_1 = rm::rLdr::create_pack_buffer("my_sub_directory/res_pack1.pk", "ioaosdjo");
        ...
        // Pack 2
        {
            rm::rLdr::PackBuffer pack_2 = rm::rLdr::create_pack_buffer("my_sub_directory/res_pack2.pk", "ioaosdjo");
