...
namespace rm::CLI
{
    ...
    void show_resource_packing_guide()
    {
        std::cout <<
            ...
            "{\n"
            "   \"input_targets: {\",\n"
            "           \"my_pack : C:/MyAssets/MyInputTargetDir            (Will read from this directory and output my_pack.pk to the output directory.)\n"
            "           \"my_second_pack : C:/MyAssets/MySecondInputDir     (Will read from this directory and output my_second_pack.pk to the output directory.)\n"
            "   \"  }\n"
